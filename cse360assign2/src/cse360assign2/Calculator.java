...
/**
 * Class constructor <code>Calculator</code> specifying private variable for total
 * and string object to store history. Class contains 6 methods: <code>getTotal, add, subtract,
...
private int total;
	...
	/**
	 * Method <code>getTotal()</code> will return the total value that has been calculated.
	 * @return
	 * total
	 */
	public int getTotal () {
	...
	/** 
	 * Method <code>subtract()</code> subtracts parameter from the existing <code>total</code> variable.
	 * @param value
	 */
